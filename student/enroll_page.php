...
if (!isset($_SESSION['student_id'])) {
    header("Location: classes.php"); // Redirige vers la page de connexion si non connecté
    exit();
}
...
<body>
  <div class="container">
    ...
    <div class="main">
      <div class="topbar">
        <div class="toggle">
          <ion-icon name="menu-outline"></ion-icon> <!-- Icône pour le menu -->
        </div>
      </div>
      <div class="card">
        <?php
            ...
            // Récupère les cours disponibles depuis la base de données
            $class_query = "SELECT * FROM classes";
            $class_result = mysqli_query($conn, $class_query);

            // Affiche les cours disponibles avec des informations supplémentaires pour l'inscription
            if (mysqli_num_rows($class_result) > 0) {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['class_id'])) {
                    ...
                    // Récupère les informations détaillées pour la classe cliquée
